...
primary_sources:
  - id: T1-SESSION
    ...
    url: "https://geminicli.com/docs/cli/session-management.md"
    section: "Full page"
also_cited_in: []
...
### Source: Session management — Full page
...
### Research note — trajectory import layout

> Official session-management docs describe retention under `general.sessionRetention` and `transcript_path` on hook payloads. Nested rollout JSONL paths used by some trajectory importers > are **not** documented in the sources reviewed; treat on-disk session file layout as partially undocumented.
