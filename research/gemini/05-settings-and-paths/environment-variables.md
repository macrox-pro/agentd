...
primary_sources:
  - id: T1-CONFIG
    ...
    section: "Environment variables in settings"
  - id: T1-AUTH
    title: "Gemini CLI authentication setup"
    url: "https://geminicli.com/docs/get-started/authentication.md"
    section: "Authentication env"
also_cited_in: []
...
### Source: Gemini CLI configuration — Env var substitution in settings
...
### Source: Gemini CLI authentication setup — Full page
