...
primary_sources:
  - id: T1-HOOKS-REF
    ...
    section: "Protocol; I/O; Decisions"
  - id: T1-GH-28046
    title: "GitHub issue #28046"
    url: "https://github.com/google-gemini/gemini-cli/issues/28046"
    section: "decision ask gap"
also_cited_in: []
...
### Source: Hooks reference — Hooks reference (protocol sections)
