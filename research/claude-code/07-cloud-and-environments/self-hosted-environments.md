...
primary_sources:
  - id: T1-SELF-HOSTED
    title: "Self-hosted"
    url: "https://code.claude.com/docs/en/self-hosted-environments-configuration.md"
    section: ""
also_cited_in: []
...
>
> Don't put a bare `"Edit"`, `"Write"`, or `"NotebookEdit"` entry in a repository-committed `permissions.allow`. A bare file-tool r
