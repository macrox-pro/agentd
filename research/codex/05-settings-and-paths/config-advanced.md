...
primary_sources:
  - id: T1-CFG-ADV
    ...
    section: "Profiles; one-off overrides; config/state locations; project config; hooks; project root; shell env; AGENTS knobs; observability (excludes Notifications, History persistence)"
also_cited_in: []
...
### Source: Advanced Configuration — (excl. Notifications, History persistence)
