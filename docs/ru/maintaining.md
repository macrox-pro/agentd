...
| Пути на диске по умолчанию (state dir, лог, sessions, сокет) | [configuration.md](./configuration.md#каталог-состояния) (канон); в DESIGN §3 / §5 / §14 — только указатели |
| Поведение проверок / Ask / Deny | [guards.md](./guards.md), [approvals.md](./approvals.md), [troubleshooting.md](./troubleshooting.md) |
...
| Установка хуков / области / точки входа / особенности | [providers.md](./providers.md) + `providers-*.md`, [getting-started.md](./getting-started.md) |
| Установка / релизы / версия | [installation.md](./installation.md) |
| Режимы ошибок / офлайн / таймауты | [troubleshooting.md](./troubleshooting.md) |
| Журнал сессий / импорт / subscribe | [trajectory.md](./trajectory.md), [cli.md](./cli.md) (команды session) |
...
- **Стиль текста:** [CONVENTIONS.md § Documentation style](../../CONVENTIONS.md#documentation-style) — тип страницы, термины для новичков, таблица RU terminology, без внутренних имён в пользовательских доках.
