...
Как выбирается маршрут события, синхронный и фоновый конвейеры, типы целей и таймауты. Подробности: [DESIGN.md §2](../../DESIGN.md#2-hook-dispatch-engine).
...
- Если в запросе уже есть срок выполнения — от него считается таймаут агента.
