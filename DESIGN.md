...
| M20 / v0.0.9 | **done** | Policy/reliability wire coverage: `policy.fail` on daemon path, `ask_fallback`, notify/serve `Cwd`; Windows daemon state paths; `e2e-m20` |

**Shipped:** v0.0.9. Session handoff + acceptance archive: [PROGRESS.md](./PROGRESS.md).
